...
fn main() {
    ...
    let session = api.login("btest2".into(), "pass1234".into()).unwrap();
    let my_priv = sm_core::crypto::decrypt_private_key(session.encrypted_private_key_b64.clone(), "pass1234".into()).unwrap();
