...
| **2а. Квитанции под политикой** | квитанции о доставке и прочтении сейчас уходят через сервер независимо от режима чата | при `DIRECT_ONLY` сервер не видит вообще ничего по этому чату |
