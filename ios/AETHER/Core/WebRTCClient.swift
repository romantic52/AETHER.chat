...
final class WebRTCClient: NSObject {
    ...
    static let iceServers: [RTCIceServer] = [
        ...
        RTCIceServer(urlStrings: ["stun:144.31.181.10:3478"]),
        RTCIceServer(urlStrings: ["turn:144.31.181.10:3478?transport=udp",
                                  "turn:144.31.181.10:3478?transport=tcp"],
                     username: "smturn", credential: "719b6a0efc869ea2b32c2ecb4ee8d0a7"),
    ]
